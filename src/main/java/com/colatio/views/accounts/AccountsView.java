package com.colatio.views.accounts;

import com.colatio.data.SamplePerson;
import com.colatio.services.SamplePersonService;
...
@PageTitle("Accounts")
@Route("accounts/:samplePersonID?/:action?(edit)")
...
public class AccountsView extends Div implements BeforeEnterObserver {
    ...
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "accounts/%s/edit";
